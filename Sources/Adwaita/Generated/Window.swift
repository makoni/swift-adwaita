...
public class Window: GtkWindow {
    ...
    /// Whether the adaptive preview mode is enabled, allowing interactive testing of breakpoints at different window
    /// sizes.
    ...
    public var content: Widget? {
        get {
            adw_window_get_content(castedPointer() as UnsafeMutablePointer<AdwWindow>)
    ...
    public var visibleDialog: Dialog? {
        adw_window_get_visible_dialog(castedPointer() as UnsafeMutablePointer<AdwWindow>)
