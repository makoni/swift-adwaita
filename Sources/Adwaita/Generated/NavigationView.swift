...
public final class NavigationView: Widget, Swipeable {
    ...
    /// Connects to the `get-next-page` signal, emitted when a new page is
    /// needed for forward navigation (e.g. swipe gestures).
    @discardableResult
    ...
    /// Connects to the `popped` signal, emitted after a page has been popped.
    ///
    ...
    /// Connects to the `pushed` signal, emitted after a page has been pushed.
    @discardableResult
    ...
    /// Connects to the `replaced` signal, emitted when the navigation stack
    /// has been replaced (e.g. all pages swapped at once).
    @discardableResult
