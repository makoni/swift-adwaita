...
- Install system dependencies first:
  - Ubuntu/Debian: `sudo apt install libadwaita-1-dev xvfb`
  - Fedora: `sudo dnf install libadwaita-devel xorg-x11-server-Xvfb`
- Build the package: `swift build`
- Run the full test suite in a virtual display: `xvfb-run swift test`
...
This package is organized as a three-layer stack:
...
- `Sources/Adwaita` is the public wrapper layer. `Widget` is the base for visual types, `Widget+FluentSetters.swift` adds method-chaining helpers, `Generated/` contains generated libadwaita wrappers, and `GtkWidgets/` contains hand-written GTK wrappers and higher-level convenience APIs.
